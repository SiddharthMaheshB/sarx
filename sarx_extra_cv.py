...
# Consecutive frame detection tracking (from sarx_camera_test.py)
CONSECUTIVE_FRAMES_REQUIRED = 3  # Require 3 consecutive frames of same person
SAME_PERSON_THRESHOLD = 0.15  # 15% of image dimension for position matching
